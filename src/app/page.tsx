...
export default function Home() {
  ...
  >(async (prevMessages, data) => {
    ...
    formData.append("message", JSON.stringify(prevMessages));
  ...
  return (
    <>
      ...
      >
        <input
          type="text"
          className="bg-transparent text-white focus:outline-hidden p-4 w-full placeholder:text-neutral-600 dark:placeholder:text-neutral-400"
          required
        ...
        {messages.length === 0 && (
          <>
            <div className="space-y-4">
              <h3 className="text-black/80 text-lg font-semibold text-center">
